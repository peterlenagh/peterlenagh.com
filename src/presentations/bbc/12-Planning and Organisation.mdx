# BBC Interview - Planning & Organising
...
<section style={{ margin: "1.5rem auto", display: "block" }}>
  ![Example high level gantt chart for a project at
  Markup](/react-pdp-section-pages-gantt.png)
</section>
