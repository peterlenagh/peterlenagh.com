import Carousel, { ArrowNext, ArrowPrevious, CarouselContextProvider, CarouselCount } from '@/components/Carousel'
                ...
                <div className={cx('carousel')}>
                    ...
                    >
                        {slides.map((element, index) => {
                            const key = element.src.substring(element.src.lastIndexOf('/') + 1).split('.')[0];
                            return (
